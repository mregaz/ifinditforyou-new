      ...
      sections={[
        {
          ...
          body: (
            <p>
              Spiega in modo semplice quali dati raccogli e perché.
            </p>
          ),
        },
        {
      ...
      faq={[
        {
          ...
          a: (
            <p>
              I pagamenti sono gestiti da Stripe. Noi non salviamo i dati della carta.
            </p>
          ),
        },
        {
          ...
          a: (
            <p>
              Sì. Dalla dashboard puoi eliminare l’account (azione irreversibile).
            </p>
          ),
        },
      ]}
